...
<div style="max-width:600px; margin:0 auto; padding:2rem 1.5rem;">
    ...
    <a href="{{ route('admin.abang.index') }}" style="color:#002f45; opacity:0.5; text-decoration:none; font-size:0.875rem; display:block; margin-bottom:1.5rem;">
        ← Kembali ke Data Abang
    </a>

    <h1 style="font-family:'Playfair Display',serif; color:#002f45; font-size:1.75rem; font-weight:700; margin-bottom:0.5rem;">
        Import Data Abang KBMS
    </h1>
    <p style="color:#002f45; opacity:0.5; font-size:0.875rem; margin-bottom:2rem;">
        Upload file Excel berisi daftar nama abang KBMS untuk ditambahkan ke database quest meet.
    </p>
    ...
    <div style="background:#002f45; border-radius:1rem; padding:1.5rem; margin-bottom:1.5rem;">
        ...
        <div style="color:#bdd1d3; font-size:0.875rem; line-height:1.8;">
            <p>File Excel harus memiliki struktur kolom bertuliskan kecil:</p>
            ...
            <p>• Baris pertama wajib diisi dengan <strong style="color:#d2c296;">header</strong> tersebut.</p>
            <p>• Kombinasi Nama dan Angkatan yang sudah ada di database akan <strong style="color:#d2c296;">dilewati otomatis</strong> untuk mencegah duplikasi data.</p>
        </div>
        <a href="{{ route('admin.abang.template') }}"
    ...
    <div style="background:white; border-radius:1rem; padding:2rem; border:2px solid #bdd1d3;">
        ...
        <form method="POST" action="{{ route('admin.abang.import.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <label for="file-upload"
                    ...
                    <p style="color:#002f45; font-weight:600; font-size:0.9rem; margin-bottom:0.25rem;">
                        Klik untuk pilih file template abang
                    </p>
