    ...
    <div style="display:grid;grid-template-columns:minmax(0,1.2fr) minmax(300px,.8fr);gap:1.25rem;margin-bottom:2rem;">
        ...
        <section style="background:#002f45;color:#fff;border-radius:1rem;padding:1.25rem;">
            ...
            <div style="display:grid;gap:.65rem;">
                ...
                <a href="{{ route('admin.absensi.password') }}" target="_blank" rel="noopener noreferrer" style="width:100%;box-sizing:border-box;padding:.7rem;border:1px solid #bdd1d3;background:transparent;color:#fff;border-radius:.5rem;text-align:left;text-decoration:none;cursor:pointer;">Absensi Password</a>
