...
@section('content')
                ...
                <div
                    ...
                    <form method="POST" action="{{ route('panitia.tugas.store') }}" enctype="multipart/form-data">
                        ...
                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.25rem; margin-bottom:1.5rem;">
                            ...
                            {{-- UPDATE: Input File Lampiran Petunjuk --}}
                            <div style="grid-column:1/-1;">
                                <label
                                    style="display:block; font-size:0.7rem; font-weight:700; color:#002f45; margin-bottom:0.5rem; text-transform:uppercase; letter-spacing:0.1em; opacity:0.6;">Lampiran
                                    File Petunjuk (PDF/Gambar)</label>
                                ...
                                <p style="font-size: 0.7rem; color: #6b705c; margin-top: 0.25rem;">* Opsional. Muncul
                                    sebagai tombol download di sisi peserta.</p>
                            </div>
                                ...
                                <div style="flex:1; min-width:250px;">
                                    ...
                                    @if ($tugas->file_petunjuk)
                                        <div style="margin-bottom:0.75rem;">
                                            <span
                                                style="font-size:0.75rem; color:#6b705c; display:flex; align-items:center; gap:0.3rem;">
                                                📄 Ada file petunjuk
                                            </span>
                                        </div>
                                    @endif
                                ...
                                <div style="display:flex; flex-direction:column; gap:0.5rem; min-width:140px;">
                                    ...
                                    @if (auth()->user()->isAcara())
                                        <form method="POST" action="{{ route('panitia.tugas.destroy', $tugas->id) }}"
                                            ...
                                            @csrf
                                            @method('DELETE') {{-- Khusus hapus harus pakai DELETE --}}
                                            <button type="submit"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Cari semua elemen alert (flash messages)
