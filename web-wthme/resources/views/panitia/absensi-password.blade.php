...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div>
            <div class="mx-auto h-20 w-20 flex items-center justify-center rounded-full bg-yellow-100">
        ...
        <form class="mt-8 space-y-6" action="{{ route('panitia.absensi.password.verify') }}" method="POST">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                    ...
                    <input 
                        ...
                        type="password" 
                        required 
                        class="appearance-none rounded relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 focus:z-10 sm:text-sm" 
            ...
            <div class="text-center">
                <a href="{{ route('panitia.index') }}" class="text-sm text-yellow-600 hover:text-yellow-500">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-xs text-yellow-700">
                        Password diupdate setiap hari oleh admin. Silakan hubungi admin jika Anda memerlukan password hari ini.
                    </p>
                </div>
            </div>
        </div>
